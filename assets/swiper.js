...
;// CONCATENATED MODULE: ./src/js/libs/swiper.js
/* eslint-disable no-undef */
// Import styles by module


__webpack_require__(6831); // Core API + modules:


 // Configure Swiper to use modules

core_class.use([navigation, pagination, thumbs, autoplay, effect_fade]); // Do not change

window.spratlyTheme = window.spratlyTheme || {};
window.spratlyTheme.Swiper = core_class;
}();
/******/ })()
;