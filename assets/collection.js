...
class Collection {
  constructor() {
    ...
    _defineProperty(this, "init", () => {
      ...
      gridColumnList === null || gridColumnList === void 0 ? void 0 : gridColumnList.forEach(elm => {
        elm.addEventListener('click', e => {
          ...
          if (!((_window$spratlyThemeS = window.spratlyThemeSettings) !== null && _window$spratlyThemeS !== void 0 && _window$spratlyThemeS.design_mode)) {
    ...
    if (!((_window$spratlyThemeS2 = window.spratlyThemeSettings) !== null && _window$spratlyThemeS2 !== void 0 && _window$spratlyThemeS2.design_mode)) {
      this.currentColumnView = window.localStorage.getItem('gridColumnViews');
    }
  }
