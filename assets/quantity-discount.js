...
function QuantityUpsell({
  ...
  return QuantityDiscount_createElement("div", {
    ...
    className: "f-quantity-upsell__products"
...
class QuantityDiscount {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "selectors", {
      productForm: '.product-template form[action*="/cart/add"]',
      hook: '.quantity-discount-hook',
      productList: '.f-quantity-upsell__products',
      productItems: ['.f-quantity-upsell__product'],
    ...
    (0,defineProperty/* default */.Z)(this, "currentVariantId", null);

    (0,defineProperty/* default */.Z)(this, "itemExisted", null);

    (0,defineProperty/* default */.Z)(this, "cart", null);

    (0,defineProperty/* default */.Z)(this, "init", async () => {
      var _this$productForm, _this$productForm$dat, _this$productForm2, _window$spratlyTheme, _window$spratlyTheme$, _this$cart, _this$cartItems;
      ...
      this.productHandle = (_this$productForm2 = this.productForm) === null || _this$productForm2 === void 0 ? void 0 : _this$productForm2.dataset.productHandle;
      console.log(this.productHandle, 'this.productHandle');
      await this.getProductJson();
      this.variantInput = this.productForm.querySelector(this.selectors.variantInput);
      ...
      this.component = quantity_discount_createElement(QuantityUpsell, {
        ...
        selectedVariant: this.currentVariantId
      });
      this.domNodes.hook.appendChild(this.component);
      this.domNodes = queryDomNodes(this.selectors);
      this.domNodes.productItems.forEach((product, index) => {
        var _this$settings;

        const quantity = product.dataset.quantity;
        const discount = (_this$settings = this.settings) === null || _this$settings === void 0 ? void 0 : _this$settings.discounts[index];
        events_addEventDelegate({
          selector: this.selectors.btnAdd,
          context: product,
          handler: (e, target) => {
            e.preventDefault();
            this.handleAddItem(quantity, discount, target);
          }
        });
      });
      this.cart = (_window$spratlyTheme = window.spratlyTheme) === null || _window$spratlyTheme === void 0 ? void 0 : (_window$spratlyTheme$ = _window$spratlyTheme.Cart) === null || _window$spratlyTheme$ === void 0 ? void 0 : _window$spratlyTheme$.cart;
      this.cartItems = ((_this$cart = this.cart) === null || _this$cart === void 0 ? void 0 : _this$cart.items) || [];
      this.itemExisted = (_this$cartItems = this.cartItems) === null || _this$cartItems === void 0 ? void 0 : _this$cartItems.find(item => item.variant_id === Number(this.currentVariantId));
      this.updateButtonStatus();
      this.listenEvents();
    });

    (0,defineProperty/* default */.Z)(this, "getProductJson", async () => {
      this.productJson = await fetch_fetchJsonCache(`/products/${this.productHandle}.js`);
    });

    (0,defineProperty/* default */.Z)(this, "updateCartAttribute", attrs => {
      this.FoxKit.updateCartAttribute(attrs);
    });

    (0,defineProperty/* default */.Z)(this, "listenEvents", () => {
      var _window, _window$_ThemeEvent, _window$_ThemeEvent$s, _window2, _window2$_ThemeEvent, _window2$_ThemeEvent$, _window3, _window3$_ThemeEvent, _window3$_ThemeEvent$;
      ...
      (_window = window) === null || _window === void 0 ? void 0 : (_window$_ThemeEvent = _window._ThemeEvent) === null || _window$_ThemeEvent === void 0 ? void 0 : (_window$_ThemeEvent$s = _window$_ThemeEvent.subscribe) === null || _window$_ThemeEvent$s === void 0 ? void 0 : _window$_ThemeEvent$s.call(_window$_ThemeEvent, 'ON_CART_UPDATE', async cart => {
        if (cart) {
          this.updateButtonStatus(cart === null || cart === void 0 ? void 0 : cart.items);
        }
      }); //Variant change

      (_window2 = window) === null || _window2 === void 0 ? void 0 : (_window2$_ThemeEvent = _window2._ThemeEvent) === null || _window2$_ThemeEvent === void 0 ? void 0 : (_window2$_ThemeEvent$ = _window2$_ThemeEvent.subscribe) === null || _window2$_ThemeEvent$ === void 0 ? void 0 : _window2$_ThemeEvent$.call(_window2$_ThemeEvent, `${this.productId}__VARIANT_CHANGE`, async variant => {
        console.log(variant, '__VARIANT_CHANGE');
      ...
      }); // TODO: Item added, should be ON_CART_UPDATE

      (_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$_ThemeEvent = _window3._ThemeEvent) === null || _window3$_ThemeEvent === void 0 ? void 0 : (_window3$_ThemeEvent$ = _window3$_ThemeEvent.subscribe) === null || _window3$_ThemeEvent$ === void 0 ? void 0 : _window3$_ThemeEvent$.call(_window3$_ThemeEvent, 'ON_ITEM_ADDED', async cart => {
        if (cart) {
          var _this$settings2;

          this.updateCartAttribute({
            offer_id: (_this$settings2 = this.settings) === null || _this$settings2 === void 0 ? void 0 : _this$settings2._id,
    ...
    (0,defineProperty/* default */.Z)(this, "handleAddItem", async (quantity, discount, target) => {
      var _window$spratlyTheme2, _window$spratlyTheme3;

      this.toggleSpinner(target, true);
      const cartJson = (_window$spratlyTheme2 = window.spratlyTheme) === null || _window$spratlyTheme2 === void 0 ? void 0 : (_window$spratlyTheme3 = _window$spratlyTheme2.Cart) === null || _window$spratlyTheme3 === void 0 ? void 0 : _window$spratlyTheme3.cart;
      const {
        items
      } = cartJson;
      const quantityToAdd = this.handleCheckQuantity(quantity, items);
      const data = {
        items: [{
      ...
      target.blur();
      this.toggleSpinner(target, false);
    });

    (0,defineProperty/* default */.Z)(this, "handleCheckQuantity", (quantity, items) => {
      // Find current product in cart items
      if (items.length === 0) return quantity;
      let totalAdded = 0;
      const found = items.filter(item => item.product_id === this.productId);

      if (found && found.length > 0) {
        found.map(f => totalAdded += f.quantity);
      }

      return quantity > totalAdded ? quantity - totalAdded : 0;
    });

    (0,defineProperty/* default */.Z)(this, "getQuantityAdded", async (cartItems = []) => {
      var _cartItems, _cartItems2, _cartItems3;

      let totalAdded = 0;

      if (!((_cartItems = cartItems) !== null && _cartItems !== void 0 && _cartItems.length)) {
        var _window$spratlyTheme$2;

        const cartJson = await ((_window$spratlyTheme$2 = window.spratlyTheme.Cart) === null || _window$spratlyTheme$2 === void 0 ? void 0 : _window$spratlyTheme$2.getCart());
        cartItems = cartJson === null || cartJson === void 0 ? void 0 : cartJson.items;
      } // Find current product in cart items


      if (((_cartItems2 = cartItems) === null || _cartItems2 === void 0 ? void 0 : _cartItems2.length) === 0) return 0;
      const found = (_cartItems3 = cartItems) === null || _cartItems3 === void 0 ? void 0 : _cartItems3.filter(item => item.product_id === Number(this.productId));
    ...
    (0,defineProperty/* default */.Z)(this, "updateButtonStatus", async cartItems => {
      var _this$settings3, _this$settings3$disco;

      this.totalAdded = await this.getQuantityAdded(cartItems);
      (_this$settings3 = this.settings) === null || _this$settings3 === void 0 ? void 0 : (_this$settings3$disco = _this$settings3.discounts) === null || _this$settings3$disco === void 0 ? void 0 : _this$settings3$disco.map((discount, index) => {
        if (this.totalAdded >= discount.min_qty) {
          this.domNodes.buttons[index].querySelector('span').textContent = quantity_discount_i18n.tr('added_button');
          this.domNodes.buttons[index].classList.add('added');
        } else {
          this.domNodes.buttons[index].querySelector('span').textContent = quantity_discount_i18n.tr('add_button');
          this.domNodes.buttons[index].classList.remove('added');
        }
      });
    });
    ...
    this.FoxKit = (_window4 = window) === null || _window4 === void 0 ? void 0 : _window4.FoxKit;
    this.init();
  }
